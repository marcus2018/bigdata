package com.example.storm.benchmark;
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length > 1) {
            if (!"--property".equals(args[1])) {
                ...
                System.out.println("usage storm jar examples-1.1-shaded.jar  WindowedWordCount benchmark.properties --property k1=v1,k2=v2");
                System.exit(1);
            }
