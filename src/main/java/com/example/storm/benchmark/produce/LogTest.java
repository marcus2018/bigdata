...
public class LogTest {
    ...
    public static void main( String[] args )
    {
        ...
        String logstore = "station_meterrecord";   // 日志服务的Logstore*/
       ...
       // String endpoint = "https://cn-shenzhen.log.aliyuncs.com";   // 日志服务访问域名
        ...
        builder.setBolt("slidingwindowbolt", new SlidingWindowBolt()
                .withWindow(new BaseWindowedBolt.Duration(30, TimeUnit.MINUTES)   ,           new BaseWindowedBolt.Duration(5, TimeUnit.MINUTES)),2)
                .shuffleGrouping("spout");//每两秒统计最近6秒的数据
            //   .fieldsGrouping("spout",new Fields("count"));
