...
public class Station_battery_damage_6min {

    private static final Logger logger = LoggerFactory.getLogger(Station_battery_damage_6min.class);
    public static void main( String[] args )
    {
        String mode = "Remote";  // 使用本地测试模式
        String conumser_group_name = "station_battery_damage_6min";   // 每个Topology 需要设定唯一的 consumer group 名字，不能为空，支持 [a-z][0-9] 和 '_'，'-'，长度在 [3-63] 字符，只能以小写字母和数字开头结尾
       ...
       // String endpoint = "https://cn-shenzhen.log.aliyuncs.com";   // 日志服务访问域名
        ...
        builder.setBolt("slidingwindowbolt", new Station_battery_damag_bolt_6min()
        ...
        if (mode.equals("Local")) {
            ...
            try {
                try {
                    StormSubmitter.submitTopology("station_battery_damage_6min", conf, builder.createTopology());
