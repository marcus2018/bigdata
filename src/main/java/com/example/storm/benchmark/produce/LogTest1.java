...
public class LogTest1 {
    ...
    public static void main( String[] args )
    {
        ...
        String conumser_group_name = "produce_losttime";   // 每个Topology 需要设定唯一的 consumer group 名字，不能为空，支持 [a-z][0-9] 和 '_'，'-'，长度在 [3-63] 字符，只能以小写字母和数字开头结尾
       ...
       // String endpoint = "https://cn-shenzhen.log.aliyuncs.com";   // 日志服务访问域名
        ...
        builder.setSpout("spout", spout, 2).setNumTasks(4);
        ...
        builder.setBolt("countwordbolt", new CountWord()
               ...
               .withWindow(new BaseWindowedBolt.Count(2), new BaseWindowedBolt.Count(2)),8)  .setNumTasks(8)
       ...
       Config.registerSerialization(conf, LogGroupData.class, LogGroupDataSerializSerializer.class);
        if (mode.equals("Local")) {
          //  logger.info("Local mode...");
            ...
            try {
                try {
                    StormSubmitter.submitTopology("produce_losttime", conf, builder.createTopology());
